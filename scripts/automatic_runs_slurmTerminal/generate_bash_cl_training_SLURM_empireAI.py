...
slurm_file_name = 'CL_alldata_resnet3p_weightedsupcon10'
gpu_num = 1
hour = 7
memory = 100 # GB
...
readme_comment = (
     "All data, 3p, supcon, 10 aug, resnet embedder, weighted loss"
)
wandb_logger_NOTES="all data 3p supcon resnet ten aug weighted" ## do NOT use any special character or new line
